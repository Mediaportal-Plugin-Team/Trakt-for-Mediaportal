...
namespace TraktPlugin
{
  public class TraktLists
  {
    ...
    public static bool GetListDetailsFromUser( ref TraktListDetail list )
    {
      ...
      if ( !GUIUtils.GetStringFromKeyboard( ref name ) )
        return false;
      if ( ( list.Name = name ) == string.Empty )
        return false;
    ...
    {
      if ( translatedString == Translation.Private )
        return "private";
      if ( translatedString == Translation.Friends )
        return "friends";
      return "public";
    }
    ...
    {
      if ( privacyLevel == "private" )
        return "traktPrivateList.png";
      if ( privacyLevel == "friends" )
        return "traktFriendsList.png";
