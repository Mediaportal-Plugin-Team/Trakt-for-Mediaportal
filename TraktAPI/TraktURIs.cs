...
namespace TraktAPI
{
  ...
  public static class TraktURIs
  {
    ...
    public const string SyncFavoritesAdd = "https://api.trakt.tv/sync/favorites";
    public const string SyncFavoritesRemove = "https://api.trakt.tv/sync/favorites/remove";
    ...
    public const string UserFavoriteItems = "https://api.trakt.tv/users/{0}/favorites/{1}/{2}/{3}?extended={4}&page={5}&limit={6}";
